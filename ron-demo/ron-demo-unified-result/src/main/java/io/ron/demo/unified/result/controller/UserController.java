package io.ron.demo.unified.result.controller;

import io.ron.common.exchange.ExcludeUnifiedResult;
import io.ron.demo.unified.result.dto.UserDTO;
...
public class UserController {
     ...
     * @return
     */
    @GetMapping("/no-unified-result")
    @ExcludeUnifiedResult
    public String noResultWrapper() {
        return "no result wrapper";
    }
